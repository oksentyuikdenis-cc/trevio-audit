 ...
 * insights that survive prioritisation. Everything downstream — the counter,
 * the insight section, and later the scene's cluster targets — reads from
 * here.
 *
...
export interface Insight {
  ...
  /**
   * What to do about it. Optional because the hand-written scenario below
   * predates it and section two is about the output format rather than about
